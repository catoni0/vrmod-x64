...
if SERVER then 
	...
	vrmod.NetReceiveLimited("vrmod_teleport",10,300,function(len, ply)
...
vrmod.AddCallbackedConvar("vrmod_smoothturnrate", "smoothTurnRate", "360", nil, nil, nil, nil, tonumber)
